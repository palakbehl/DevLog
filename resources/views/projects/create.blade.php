...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-extrabold text-gray-900 dark:text-zinc-50 tracking-tight">Create Project</h1>
            <p class="text-sm text-gray-500 mt-1 dark:text-zinc-400">Add a new project to your portfolio.</p>
        </div>
    ...
    <!-- Form Card -->
    <x-card>
        <form action="{{ url('/projects') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Thumbnail Upload -->
                <div class="md:col-span-2 space-y-1.5 w-full">
